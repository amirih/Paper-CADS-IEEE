			...
			int i=0,j=0;
				...
				for(i=P/2; i<N-(P/2); i++){
					for(j=Q/2; j<M-(Q/2); j+=16){
						...
						//additions
						__m256i vec0 = 	_mm256_add_epi16(_mm256_add_epi16(_mm256_add_epi16(input00, input01) , _mm256_add_epi16(input02, input03)) , input04);
						__m256i vec1 = 	_mm256_add_epi16(_mm256_add_epi16(_mm256_add_epi16(input10, input11) , _mm256_add_epi16(input12, input13)) , input14);
						__m256i vec2 = 	_mm256_add_epi16(_mm256_add_epi16(_mm256_add_epi16(input20, input21) , _mm256_add_epi16(input22, input23)) , input24);
						__m256i vec3 = 	_mm256_add_epi16(_mm256_add_epi16(_mm256_add_epi16(input30, input31) , _mm256_add_epi16(input32, input33)) , input34);
						__m256i vec4 = 	_mm256_add_epi16(_mm256_add_epi16(_mm256_add_epi16(input40, input41) , _mm256_add_epi16(input42, input43)) , input44);
						
						__m256i result = _mm256_add_epi16(_mm256_add_epi16(_mm256_add_epi16(vec0, vec1) , _mm256_add_epi16(vec2, vec3)) , vec4);//printf("  result : "); printVeci16(result);
